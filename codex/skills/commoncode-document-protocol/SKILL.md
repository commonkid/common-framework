---
name: commoncode-document-protocol
description: STRUCTURAL PROTOCOL for project documentation. Mandatory for generating all structured AI-friendly documents (requirements, specifications, etc.). Loaded by commoncode-mode-architect during document generation.
---
