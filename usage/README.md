...
| строка цен | **третья строка**, без рамки и разделителей, выровнена по правой колонке — ровно под полосой контекста: `session` — стоимость этого чата, `tree` — стоимость всей рабочей ветки |
...
DEPLOY ●━●━●━●━●━●━◉─○─○─○─○  QA · Manual QA · 9m53s     50e0485d  session $1.84 tree $12.4
```
...
**Стоимость ветки** (`tree`) — сколько стоила текущая рабочая ветка целиком: все чаты, когда-либо
