---
name: data-transform
description: Guide for data transformation (ETL, Pandas, SQL) for AI developers. Use when handling complex data manipulations, joining tables, or optimizing performance in Python/SQL environments. Loaded by mode-architect or mode-code when the task touches ETL / data-processing domains.
---
